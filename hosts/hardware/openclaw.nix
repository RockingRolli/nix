...
# lives in ../openclaw.nix (the host file), NOT here — `nixos-generate-config`
...
#     --generate-hardware-config nixos-generate-config hosts/hardware/openclaw.nix \
#     --flake .#openclaw root@<vm-ip>
